import { UserLayout, ListLayout, TabLayout, RouteView, BlankLayout, PageView } from '@/components/layouts'
...
export const constantRouterMap = [
  ...
  // redirect: '/iswork/productionSurface',
  //   hidden: true,
  //   children: [
  //     {
  //       path: 'surface',
  //       name: 'surface',
  //       component: () => import(/* webpackChunkName: "user" */ '@/views/work/surface')
  //     },
  //     {
  //       path: 'productionSurface',
  //       name: 'productionSurface',
  //       component: () => import(/* webpackChunkName: "user" */ '@/views/work/productionSurface')
  //     }
  //   ]
  // },
