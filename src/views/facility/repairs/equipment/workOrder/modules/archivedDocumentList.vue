...
export default {
  ...
  data() {
    return {
      ...
      url: {
        // downloadFile
        list: '/fixworkorder/fixWorkOrderDocument/list',
        deleteBatch: '/fixworkorder/fixWorkOrderDocument/deleteBatch',
        // download: '/fixworkorder/fixWorkOrderDocument/download?id=',
        download: '/fixworkorder/fixWorkOrderDocument/downloadFile?id=',
        add: '/fixworkorder/fixWorkOrderDocument/add'
      },
      workOrderId: ''
    }
  },
  ...
  methods: {
    ...
    handleAdd() {
      this.queryParam.documentType = '6'
    ...
    handleOk() {
      ...
      if (this.fileList.length != 0) {
        ...
        fileList.forEach(file => {
          pm.append('fixWorkOrderDocuments', file)
        })
        pm.append('documentType', this.queryParam.documentType)
        pm.append('fixWorkOrderId', this.workOrderId)
