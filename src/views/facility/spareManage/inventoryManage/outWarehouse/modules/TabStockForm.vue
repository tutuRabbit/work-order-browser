      ...
      <a-row>
        ...
        <a-col :span="8">
          <a-form-model-item label="出库日期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="stockTime">
            <j-date :disabled="formDisabled" v-model="tabStock.stockTime" style="width:100%" dateFormat="YYYY-MM-DD" />
          </a-form-model-item>
        </a-col>
        <a-col :span="8">
        ...
        <a-col :span="8">
          <a-form-model-item label="客户" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="supplier">
            <!-- <j-dict-select-tag
              ...
              placeholder="请选择供用商"
            ></j-dict-select-tag> -->
            <a-select :disabled="formDisabled" v-model="tabStock.supplier" placeholder="请选择客户公司">
          ...
          <a-row :gutter="24">
            ...
            <a-col :span="8">
              <a-form-item label="仓库">
                <a-select v-model="queryParam.storeHouse" allowClear :showSearch="true" optionFilterProp="label">
                  <template v-for="(item, index) of storeHouseList">
                    <a-select-option :value="item.id" :key="index" :label="item.storeName" @change="searchQuery">{{
                      item.storeName
                    }}</a-select-option>
                  </template>
                </a-select>
  ...
  methods: {
    changeCheck() {
      ...
      if (this.checkUnit) {
        ...
        that.table.columns.unshift(pm)
        that.table.columns.unshift(em)
        this.$forceUpdate()
