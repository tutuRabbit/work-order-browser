    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="消息标题">
          <a-input :read-only="disableSubmit" placeholder="请输入消息标题" v-decorator="['esTitle', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送内容">
          <a-input :read-only="disableSubmit" placeholder="请输入发送内容" v-decorator="['esContent', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送所需参数">
          <a-input :read-only="disableSubmit" placeholder="请输入发送所需参数Json格式" v-decorator="['esParam', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="接收人">
          <a-input :read-only="disableSubmit" placeholder="请输入接收人" v-decorator="['esReceiver', {}]" />
        </a-form-item>
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送次数">
          <a-input-number :disabled="disableSubmit" v-decorator="['esSendNum', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="发送失败原因">
          <a-input :read-only="disableSubmit" v-decorator="['esResult', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="备注">
          <a-input :read-only="disableSubmit" v-decorator="['remark', {}]" />
        </a-form-item>
      </a-form>
    </a-spin>
