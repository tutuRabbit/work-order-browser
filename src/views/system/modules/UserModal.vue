      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <template v-if="!model.id">
          <a-form-model-item label="登录密码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="password">
            <a-input :disabled="disableSubmit" type="password" placeholder="请输入登录密码" v-model="model.password" />
          </a-form-model-item>
        ...
        <a-form-model-item label="用户姓名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="realname">
          <a-input :disabled="disableSubmit" placeholder="请输入用户姓名" v-model="model.realname" />
        </a-form-model-item>

        <a-form-model-item label="工号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="workNo">
          <a-input :disabled="disableSubmit" placeholder="请输入工号" v-model="model.workNo" />
        </a-form-model-item>

        <a-form-model-item label="手机号码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="phone">
          <a-input :disabled="disableSubmit" placeholder="请输入手机号码" v-model="model.phone" />
        </a-form-model-item>
        ...
        <a-form-model-item
          label="租户分配"
          :rules="[{ required: true, message: '请填写租户分配!' }]"
          :labelCol="labelCol"
        ...
        <a-form-model-item label="身份" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-radio-group :disabled="disableSubmit" v-model="model.userIdentity" @change="identityChange">
        ...
        <a-form-model-item label="邮箱" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="email">
          <a-input :disabled="disableSubmit" placeholder="请输入邮箱" v-model="model.email" />
        </a-form-model-item>

        <a-form-model-item label="座机" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="telephone">
          <a-input :disabled="disableSubmit" placeholder="请输入座机" v-model="model.telephone" />
        </a-form-model-item>
