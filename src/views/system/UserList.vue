<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator" style="border-top: 5px">
      ...
      <a-button type="primary" icn="download" @click="handleExportXls('用户信息')" v-has="'user:export'">导出</a-button>
      <a-button type="primary" icon="import" v-has="'user:import'" @click="importVisible = true">导入</a-button>
      <!-- <a-upload
        name="file"
      ...
      >
        <a-button type="primary" icon="import" v-has="'user:import'">导入</a-button>
      </a-upload> -->
      <j-third-app-button
        biz-type="user"
      ...
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay" @click="handleMenuClick">
          ...
          <a-menu-item key="2" v-has="'user:status1'">
            <a-icon type="lock" @click="batchFrozen('2')" />
            冻结
          </a-menu-item>
          <a-menu-item key="3" v-has="'user:status2'">
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item>
                <a href="javascript:;" @click="handleDetail(record)" v-has="'user:views'">详情</a>
              </a-menu-item>

              <a-menu-item>
                <a href="javascript:;" @click="handleChangePassword(record.username)" v-has="'user:password'">密码</a>
              </a-menu-item>
              ...
              <a-menu-item v-if="record.status == 1" v-has="'user:status1'">
                <a-popconfirm title="确定冻结吗?" @confirm="() => handleFrozen(record.id, 2, record.username)">
                  <a>冻结</a>
                </a-popconfirm>
              </a-menu-item>

              <a-menu-item v-if="record.status == 2" v-has="'user:status2'">
              ...
              <a-menu-item>
                <a href="javascript:;" @click="handleAgentSettings(record.username)" v-has="'user:setting'">代理人</a>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
        </span>
    ...
    <!-- 导入 -->
    <j-modal title="导入用户" width="45%" :visible="importVisible" cancelText="关闭" @cancel="handleCancel">
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="24">
            <a-col :span="24">
              <p>操作步骤:</p>
              <p>1.下载<a @click="downFiles">《导入用户模板》</a></p>
            </a-col>
            <a-col :span="24">
...
import { putAction, getFileAccessHttpUrl, uploadAction, downFile } from '@/api/manage'
  ...
  data() {
    return {
      ...
      url: {
        ...
        importExcelUrl: 'sys/user/importExcel', //导入接口
        download: '/attachment/tabAttachment/download?id=1' //用户导入模板
      }
    }
  },
  computed: {
    ...
    downFiles() {
      downFile(this.url.download).then(data => {
        ...
        if (typeof window.navigator.msSaveBlob !== 'undefined') {
          ...
          link.href = url
          link.setAttribute('download', '用户导入模板' + Math.round(new Date().getTime()).toString())
