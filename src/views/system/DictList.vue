  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      ...
      <div class="table-operator" style="border-top: 5px">
        <a-button @click="handleAdd" type="primary" icon="plus" v-has="'dict:add'">添加</a-button>
        ...
        <a-button type="primary" icon="hdd" @click="openDeleteList" v-has="'dict:recycle'">回收站</a-button>
      </div>
      ...
      >
        <span slot="action" slot-scope="text, record">
          ...
          <a-divider type="vertical" v-has="'dict:edit'" />
          <a @click="editDictItem(record)" v-has="'dict:setting'"><a-icon type="setting" /> 字典配置</a>
          <a-divider type="vertical" v-has="'dict:setting'" />
          <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete(record.id)" v-has="'dict:delete'">
            <a>删除</a>
          </a-popconfirm>
        </span>
      </a-table>
    ...
    <!-- 字典类型 -->
    <dict-item-list ref="dictItemList" @bar="refleshCache"></dict-item-list>
