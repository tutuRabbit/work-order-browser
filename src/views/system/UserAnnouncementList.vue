        ...
        <a-row :gutter="24">
          <a-col :span="6">
            <a-form-item label="标题">
              <a-input style="width:100%" placeholder="请输入标题" v-model="queryParam.titile"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="6">
            <a-form-item label="发布人">
              <a-input style="width:100%" placeholder="请输入发布人" v-model="queryParam.sender"></a-input>
            </a-form-item>
          </a-col>
